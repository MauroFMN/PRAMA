        ...
        <div class="formulario">
          ...
          while ($row = mysqli_fetch_assoc($dados)) { ?>
            <form id="form" style="display: block;" class="formRegElm">
              ...
              <input type="text" name="numeroDocumento" id="numeroDocumento" value="<?php echo $row['numeroDocumento']; ?>" <?php echo isset($_GET['editar']) ? "" : "disabled"; ?>>
              <?php
              ...
              <input type="text" name="endereco" id="endereco" value="<?php echo $row['endereco']; ?>" <?php echo isset($_GET['editar']) ? "" : "disabled"; ?>>
              <?php
              ...
              while ($endereco = mysqli_fetch_assoc($email)) { ?>
                ...
                <input type="email" name="email" id="email" value="<?php echo $endereco['endereco']; ?>" <?php echo isset($_GET['editar']) ? "" : "disabled"; ?> style="width: auto;height: 50px;"><br>
              <?php } ?>
              <?php
              ...
              while ($row3 = mysqli_fetch_assoc($dados3)) { ?>
                ...
                <input type="tel" name="numero" id="numero" value="<?php echo $row3['numero']; ?>" <?php echo isset($_GET['editar']) ? "" : "disabled"; ?> style="width: auto">
              <?php } ?>
              <hr>
